<template>
  <div class="xfn-table-info">
    ...
    <!-- 对话框尾部 -->
    <div slot="footer">
      <el-button type="primary" @click="dialogTableDetailVisible=false">确定
      </el-button>
    </div>
    </el-dialog>
  </div>
...
export default {
  ...
  methods: {
    ...
    makeQRCode() {
      //创建二维码-注意次方法不能在当前组件的mounted中调用，因为绘图必需的canvas在el-dialog中，对话框在组件加载时并不在DOM树上
      var qrcode = require('qrcode');
      //var canvas = this.$refs.qrcanvas ;
      //每个桌子对应的URL应该形如：http://127.0.0.1:8902/#/3;
